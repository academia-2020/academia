...
from .views import AlcanceUpdateView, AlcanceDeleteView, AlcanceCreateView
from .views import RecomendacionUpdateView, RecomendacionDeleteView, RecomendacionCreateView
from .views import CapituloUpdateView, CapituloDeleteView, CapituloCreateView
from .views import TemaUpdateView, TemaDeleteView, TemaCreateView
from .views import DetalleUpdateView, DetalleDeleteView, DetalleCreateView
